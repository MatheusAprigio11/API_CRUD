import sys
default_path ="c:\\Users\\jem4ca\\Desktop\\fast_api"
...
from sqlalchemy.future import select # AQUI FORÇAMOS O USO DO ESTILO 2.0
...
#API ENVIA UM JSON E ESPERA RECEBER JSON
router = APIRouter()
#POST CURSOS
